...
import com.totalit.bloodbankstatement.controller.BaseResource;
...
import com.totalit.bloodbankstatement.util.DateUtil;
...
//    @GetMapping("/get-physicians")
//    public List<User> getPhysicians(@RequestHeader(value = "Company") String companyString) {
//        List<User> users = userService.getAll(StringUtils.stringToCompanyObject(companyString));
//        List<User> list = new ArrayList<>();
//        users.stream().forEach(item ->{
//            if(item.getUserRoles().contains(roleService.getByName("ROLE_DOCTOR"))){
//                list.add(item);
//            }
//        });
//        return list;
