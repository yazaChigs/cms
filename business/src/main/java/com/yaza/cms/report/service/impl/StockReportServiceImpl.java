...
//        }
    ...
    private Double calculateMonthlyValueGreen(Date start, Date end, Branch branch) {
        Double bsms = 0.0;
        Integer green = 0;
        Integer total = 0;
...
//            }
//        }
//        return (green.doubleValue()/checkZero(total))*100;
//    }
//    private Double calculateMonthlyValueRed(Date start, Date end, Branch branch) {
//        Double bsms = 0.0;
//        Integer red = 0;
//        Integer total = 0;
...
//        }
//        return (red.doubleValue()/checkZero(total))*100;
//    }
//    private Double calculateMonthlyValueOrange(Date start, Date end, Branch branch) {
//        Double bsms = 0.0;
//        Integer orange = 0;
//        Integer total = 0;
//
...
////            }
//        }
//            return ((orange.doubleValue() / checkZero(total)) * 100);
//    }
