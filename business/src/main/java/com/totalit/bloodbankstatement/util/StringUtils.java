 ...
 */
package com.totalit.bloodbankstatement.util;
...
public final class StringUtils {
    ...
    public static Branch stringToCompanyObject(String branchString) {
        Branch branch = null;
        try {
            branch = new ObjectMapper().readValue(branchString, Branch.class);//Convert String To Company Object
        } catch (IOException e) {
            e.printStackTrace();
        }
        return branch;
